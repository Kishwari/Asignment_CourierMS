...
public class CourierAdminServiceCollectionImpl extends CourierUserServiceCollectionImpl implements ICourierAdminService {
    ...
    //Code for accessing functionalities of CourierUserServiceImpl class starts
        ...
        CourierAdminServiceCollectionImpl courierAdminService = new CourierAdminServiceCollectionImpl(company);
        ...
        List<String> assignedOrders = courierAdminService.getAssignedOrders(1); // assuming courier staff ID 1
        ...
        //Code for accessing functionalities of CourierUserServiceImpl class ends
         ...
         ICourierAdminService courierAdminService1 = new CourierAdminServiceCollectionImpl(courierStaffList, courierList);
    Employee employee1 = new Employee(1, "Ishwari Raj", "ishwari@example.com", 1234567890, "Courier Staff", 50000);
